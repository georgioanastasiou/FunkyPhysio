...
export default function WhatWeDo() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            ...
            // dot 0 active 0–0.38, dot 1 active 0.38–0.75, dot 2 active 0.75–1
      ...
      // ── Phase 1: Panel 1 text reveals (tl 0 → 1.8) ──
      ...
      // ── Phase 2: Slide track to Panel 2 (tl 2 → 3) ──
        .to(track, { x: -vw, ease: 'power2.inOut', duration: 1 }, 2)

      // ── Phase 3: Panel 2 text reveals (tl 3 → 4.5) ──
      ...
      // ── Phase 4: Slide track to Panel 3 (tl 4.8 → 5.8) ──
        .to(track, { x: -2 * vw, ease: 'power2.inOut', duration: 1 }, 4.8)

      // ── Phase 5: Panel 3 text reveals (tl 5.8 → 7.2) ──
      ...
      >
        ...
        <div className="relative w-screen h-full flex-shrink-0 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-32">
            <p className="p1-label text-[10px] uppercase tracking-[5px] text-white/50 font-syne mb-4 md:mb-8">
              01 — Physiotherapy
            </p>
            ...
            <p className="p1-body text-white/60 font-syne text-xs md:text-base max-w-[260px] md:max-w-sm leading-relaxed mb-4 md:mb-8">
              Evidence-based physiotherapy tailored to your body. From rehabilitation
              to injury prevention, we restore your movement and strength.
            </p>
            <ul className="space-y-2 md:space-y-3">
              {['Treatment Sessions', 'Rehabilitation', 'Prevention & Education'].map((item) => (
                <li key={item} className="p1-items text-white/45 font-syne text-[10px] md:text-xs uppercase tracking-[2px] md:tracking-[3px] flex items-center gap-3">
                  <span className="inline-block w-4 md:w-6 h-px bg-white/30 flex-shrink-0" />
                  {item}
                </li>
              ))}
            </ul>
        ...
        <div className="relative w-screen h-full flex-shrink-0 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-32">
            <p className="p2-label text-[10px] uppercase tracking-[5px] text-white/50 font-syne mb-4 md:mb-8">
              02 — Movement Training
            </p>
            <h2 className="font-syne font-semibold text-white leading-none mb-4 md:mb-8">
            ...
            <p className="p2-body text-white/60 font-syne text-xs md:text-base max-w-[260px] md:max-w-sm leading-relaxed mb-4 md:mb-8">
              Functional movement and therapeutic training to rebuild strength, correct posture,
        ...
        <div className="relative w-screen h-full flex-shrink-0 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-32">
            <p className="p3-label text-[10px] uppercase tracking-[5px] text-white/50 font-syne mb-4 md:mb-8">
              03 — Wellness Massage
            </p>
            <h2 className="font-syne font-semibold text-white leading-none mb-4 md:mb-8">
            ...
            <p className="p3-body text-white/60 font-syne text-xs md:text-base max-w-[260px] md:max-w-sm leading-relaxed mb-4 md:mb-8">
              From sports massage to deep tissue techniques, our hands-on therapy relieves
              tension, aids recovery, and revitalizes your body.
            </p>
            <ul className="space-y-2 md:space-y-3">
