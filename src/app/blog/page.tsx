    ...
    <div className="min-h-screen bg-white">
      ...
      <section data-nav-theme="light" className="bg-[#f5f0eb] pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-syne text-funky-black leading-tight mb-6">
            Health tips &<br />expert advice
          </h1>
          <p className="text-gray-500 font-syne text-base md:text-lg max-w-xl leading-relaxed">
